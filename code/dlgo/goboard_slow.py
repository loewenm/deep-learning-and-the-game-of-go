# -*- coding: utf-8 -*-
"""
Created on Fri Feb  7 17:51:00 2020
...
# List of public objects of  module as interpreted by import *.
...
# <1> Go strings are stones that are linked by a chain of connected stones of 
#     the same color.
...
class Board():  # <1>
    def __init__(self, num_rows, num_cols):
        ...
        self._grid = {}
# <1> A board is initialized as empty grid with the specified number of rows 
#     and columns.
...
# <1> Removing a string can create liberties for other strings.
    ...
    def get_go_string(self, point):  # <2>
        ...
        if string is None:
            return None
        return string
# <1> Returns the content of a point on the board:  a Player if there is a 
#     stone on that point or else None.
# <2> Returns the entire string of stones at a point: a GoString if there is a 
#     stone on that point or else None.
...
# <1> Any action a player can play on a turn, either is_play, is_pass or 
#     is_resign will be set.
